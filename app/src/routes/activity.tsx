...
const KIND_LABEL: Record<EventKind, string> = {
  ...
  policy_discarded: "Policy moved to Trash",
  policy_restored: "Policy restored from Trash",
  policy_purged: "Policy permanently deleted",
...
function formatSource(source: string): string {
  ...
  const labels: Record<string, string> = {
    "log-touchpoint": "Cronos / log-touchpoint",
    "complete-reminder": "Cronos / complete-reminder",
    "snooze-reminder": "Cronos / snooze-reminder",
    "cancel-reminder": "Cronos / cancel-reminder",
    "merge-contacts": "App / merge",
    "cleanup-duplicates": "Cleanup utility",
    "add-policy": "Cronos / add-policy",
    "update-policy": "Cronos / update-policy",
    "archive-policy": "Cronos / archive-policy",
    "app:edit-contact": "App / edit",
    "app:daily-focus": "App / daily focus",
    "app:settings": "App / settings",
    "hermes:update-contact-fields": "Cronos / update-contact",
    "hermes:queue-clarification": "Cronos / queue clarification",
